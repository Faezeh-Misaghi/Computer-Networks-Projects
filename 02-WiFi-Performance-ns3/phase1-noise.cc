...
int main (int argc, char *argv[])
{
    ...
    WifiMacHelper mac;
    Ssid ssid = Ssid("my-wifi5-network");
    ...
    monitor->SerializeToXmlFile("flowmon2.xml", true, true);
    // monitor->SerializeToXmlFile("flowmon3.xml", true, true);
    // monitor->SerializeToXmlFile("flowmon4.xml", true, true);
